...
int main() {
	//Open, then clear "CardCatalog.txt"
...
//Count the number of words in the text starting after the Contents:line
...
//Count the number of lines in the text starting after the Contents: line
...
//Count the amount of letters, then finds the frequency of each letter
